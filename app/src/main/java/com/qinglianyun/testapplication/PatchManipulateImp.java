...
public class PatchManipulateImp extends PatchManipulate {
    ...
    protected List<Patch> fetchPatchList(Context context) {
        ...
        patch.setName("com.qinglianyun.testapplication");
        //we recommend LocalPath store the origin patch.jar which may be encrypted,while TempPath is the true runnable jar
        ...
        patch.setLocalPath(Environment.getExternalStorageDirectory().getPath() + File.separator + "QLYrobust" + File.separator + "patch");
        ...
        //请注意这里的设置
        patch.setPatchesInfoImplClassFullName("com.qinglianyun.testapplication.patch.PatchesInfoImpl");
...
//        patch.setTempPath(context.getCacheDir() + File.separator + "robust" + File.separator + "patch");
        patch.setTempPath(Environment.getExternalStorageDirectory().getPath() + File.separator + "QLYrobust11" + File.separator + "patch");
    ...
    public void copy(String srcPath, String dstPath) throws IOException {
        ...
        if (!src.exists()) {
            throw new RuntimeException("source patch does not exist " + srcPath + "  dstPath: " + dstPath);
        }
        ...
        try {
            ...
            in.close();
            Log.d("复制 ", "srcPath " + src.getPath() + "  " + src.length());
            Log.d("复制 ", "dstPath " + dst.getPath() + "  " + dst.length());
        }
    }
